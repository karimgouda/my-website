...
<!-- Control Center for Material Dashboard: parallax effects, scripts for the example pages etc --><script src="{{asset('backend')}}/assets/js/material-dashboard.min.js?v=3.1.0"></script>
